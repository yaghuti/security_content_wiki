...
| search                | str    | Splunk search to be executed                                                | [Example](https://github.com/splunk/security_content/blob/e2f910a427399813bd7e959f48423728e3c292bb/detections/application/crushftp_server_side_template_injection.yml#L11) |
...
| risk_score            | int    | A number between 0-100 that represents the risk score of the detection      |  [How to calculate](https://github.com/splunk/security_content/wiki/How-are-risk-score-calculated-for-RBA)                     |
