...
| Baseline | A posture analytic is designed to help in the maintenance of the analytic or create a baseline of data for detections to leverage. | [Baseline of API Calls per User ARN](https://github.com/splunk/security_content/blob/develop/baselines/baseline_of_api_calls_per_user_arn.yml) |
...
| Investigation | An analytic that is used to investigate an entity or asset, usually executed after another analytic type finds results as a next step in the workflow. They are executed after a result is found as  | [AWS Investigate User Activities By ARN](https://github.com/splunk/security_content/blob/develop/response_tasks/aws_investigate_user_activities_by_arn.yml) |
